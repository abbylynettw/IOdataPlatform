...
{   
    ...
    [Display(Name = "机箱号")]
    public int 机箱号 { get; set; } 

    [Display(Name = "槽位号")]
    public int 槽位号 { get; set; } 
    ...
    [Display(Name = "机箱供电")]
    public string 机箱供电 { get; set; } = string.Empty;
    ...
    [Display(Name = "系统名")]
    public string 系统名 { get; set; } = string.Empty;

    [Display(Name = "去向专业")]
    public string 去向专业 { get; set; } = string.Empty;
