...
public class Status : ObservableObject
{
	...
	[ObservableProperty]
	[NotifyPropertyChangedFor("IsFree")]
	private bool isBusy;

	/// <summary>状态栏文本的颜色画刷，用于区分不同类型的状态信息</summary>
	[ObservableProperty]
	private SolidColorBrush brush = new SolidColorBrush(Colors.White);

	/// <summary>指示应用程序是否处于空闲状态（与IsBusy相反）</summary>
	public bool IsFree => !IsBusy;

	/// <inheritdoc cref="F:IODataPlatform.Models.Status.statusText" />
	...
	/// <inheritdoc cref="F:IODataPlatform.Models.Status.progress" />
	[GeneratedCode("CommunityToolkit.Mvvm.SourceGenerators.ObservablePropertyGenerator", "8.2.0.0")]
	[ExcludeFromCodeCoverage]
	public double Progress
	{
		...
		set
		{
			if (!EqualityComparer<double>.Default.Equals(progress, value))
			{
	...
	/// <inheritdoc cref="F:IODataPlatform.Models.Status.isBusy" />
	[GeneratedCode("CommunityToolkit.Mvvm.SourceGenerators.ObservablePropertyGenerator", "8.2.0.0")]
	[ExcludeFromCodeCoverage]
	public bool IsBusy
	{
	...
	/// <inheritdoc cref="F:IODataPlatform.Models.Status.brush" />
	[GeneratedCode("CommunityToolkit.Mvvm.SourceGenerators.ObservablePropertyGenerator", "8.2.0.0")]
	[ExcludeFromCodeCoverage]
	public SolidColorBrush Brush
	{
		...
		set
		{
			if (!EqualityComparer<SolidColorBrush>.Default.Equals(brush, value))
			{
				OnPropertyChanging(__KnownINotifyPropertyChangingArgs.Brush);
				brush = value;
				OnPropertyChanged(__KnownINotifyPropertyChangedArgs.Brush);
			}
		}
	}
