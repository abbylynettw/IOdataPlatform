...
/// ExtractPdfPage
/// </summary>
public class ExtractPdfPage : Page, IComponentConnector
{
	...
	public void InitializeComponent()
	{
		...
		{
			_contentLoaded = true;
			Uri resourceLocator = new Uri("/IODataPlatform;V1.2.0.0;component/views/subpages/common/extractpdfpage.xaml", UriKind.Relative);
