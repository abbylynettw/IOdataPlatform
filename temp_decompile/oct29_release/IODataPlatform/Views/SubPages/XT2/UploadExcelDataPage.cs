...
/// UploadExcelDataPage
/// </summary>
public class UploadExcelDataPage : Page, IComponentConnector
{
	...
	public void InitializeComponent()
	{
		...
		{
			_contentLoaded = true;
			Uri resourceLocator = new Uri("/IODataPlatform;V1.2.0.0;component/views/subpages/xt2/uploadexceldatapage.xaml", UriKind.Relative);
