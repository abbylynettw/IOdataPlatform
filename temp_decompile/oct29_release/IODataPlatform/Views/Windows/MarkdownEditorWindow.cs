...
/// </summary>
public class MarkdownEditorWindow : FluentWindow, IComponentConnector
{
	...
	internal Button BtnInsertImage;

	internal WebView2 EditorWebView;
	...
	public void InitializeComponent()
	{
		...
		{
			_contentLoaded = true;
			Uri resourceLocator = new Uri("/IODataPlatform;V1.2.0.0;component/views/windows/markdowneditorwindow.xaml", UriKind.Relative);
	...
	void IComponentConnector.Connect(int connectionId, object target)
	{
		...
		case 1:
			...
			break;
		case 2:
			BtnInsertImage = (Button)target;
			BtnInsertImage.Click += InsertImage_Click;
			break;
		case 3:
			EditorWebView = (WebView2)target;
			break;
		case 4:
