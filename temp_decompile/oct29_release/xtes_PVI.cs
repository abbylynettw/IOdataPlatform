...
public class xtes_PVI
{
	...
	[Display(Name = "FREQUENCY - 脉冲量属性")]
	public string FREQUENCY { get; set; }

	[Display(Name = "MAXPW - 最大脉冲宽度（毫秒）")]
	public string MAXPW { get; set; }

	[Display(Name = "MINPW - 最小脉冲宽度（毫秒）")]
	public string MINPW { get; set; }

	[Display(Name = "PFT - 脉冲滤波时间（毫秒）")]
